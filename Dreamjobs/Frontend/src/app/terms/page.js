...
const Terms = () => {
    return (
        <>
        <div className="pl-2 pr-2 flex flex-col gap-2 justify-center items-center">
        <h2 className="underline text-3xl font-extrabold">Terms and Conditions</h2>

        <h3 className="underline text-2xl font-bold">AGREEMENT TO TERMS</h3>
        ...
        Street:  Plot No.d-55/56, Unit 1, Ttc Indl.area, Thane Belapur Road, Turbhe, Navi Mumbai

        City:   Mumbai

        State/province/area:    Maharashtra

        Phone number:  02227672757
