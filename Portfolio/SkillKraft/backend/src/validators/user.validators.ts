...
export const UpdateProfileBody = z.object({
    ...
    weeklyHours: z.number().positive({error: 'Should be a positive number'}).min(2, 'Min hours cannot be less than 2 hours').max(20, 'Max hours cannot exceed 20 hours per week'),
